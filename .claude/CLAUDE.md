...
- **Agent Name:** tauri-builder-2
- **Task ID:** spacebot-7l0
- **Spec:** No spec file provided
- **Branch:** overstory/tauri-builder-2/spacebot-7l0
- **Worktree:** /Users/peetstander/Developer/spacebot/.overstory/worktrees/tauri-builder-2
- **Parent:** tauri-lead
- **Depth:** 2
...
Your worktree root is: `/Users/peetstander/Developer/spacebot/.overstory/worktrees/tauri-builder-2`

**CRITICAL**: All file operations MUST use paths within this directory.
- Use paths relative to your worktree root, or absolute paths starting with `/Users/peetstander/Developer/spacebot/.overstory/worktrees/tauri-builder-2`
...
These paths are relative to your worktree root: `/Users/peetstander/Developer/spacebot/.overstory/worktrees/tauri-builder-2`
...
Use `overstory mail` for all communication. Your address is **tauri-builder-2**.

```bash
# Check your inbox (do this regularly)
overstory mail check --agent tauri-builder-2

# Send a status update to your parent
overstory mail send --to tauri-lead --subject "status" \
  --body "Progress update here" --type status --agent tauri-builder-2

# Ask a question
overstory mail send --to tauri-lead --subject "question" \
  --body "Your question here" --type question --priority high --agent tauri-builder-2

# Report completion
overstory mail send --to tauri-lead --subject "done" \
  --body "Summary of what was done" --type result --agent tauri-builder-2

# Reply to a message
overstory mail reply <message-id> --body "Your reply" --agent tauri-builder-2
```
...
4. **Commit:** all changes committed to your branch (overstory/tauri-builder-2/spacebot-7l0)
...
6. **Signal completion:** send `worker_done` mail to tauri-lead: `overstory mail send --to tauri-lead --subject "Worker done: spacebot-7l0" --body "Quality gates passed." --type worker_done --agent tauri-builder-2`
7. **Close issue:** `bd close spacebot-7l0 --reason "summary of changes"`
...
- **WORKTREE ISOLATION**: All writes MUST target files within your worktree at `/Users/peetstander/Developer/spacebot/.overstory/worktrees/tauri-builder-2`
- NEVER write to the canonical repo root — all writes go to your worktree copy
- Only modify files in your File Scope
- Commit only to your branch: overstory/tauri-builder-2/spacebot-7l0
